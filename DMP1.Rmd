...
![Figure 1. Area Map](img/rio-grande-basin.png){ widght=50% }
...
the entire geodatabase [^1].

[^1]:The FGDC standard was chosen due to required Federal government
standards.
...
with University/Participating institutional and NSF policies. 
[See, for example, @Briney_2015].Depending
